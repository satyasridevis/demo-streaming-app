...
app.get('/', (req, res) => {
    res.send(
      "<h1><a href='http://localhost:3000/video1' target='_blank'>create a S3 bucket with terraform </a><br><a href='http://localhost:3000/video2' target='_blank'>Installing AWS EBCLI in centos </a></h1>"
    );
})
